...
<body>
            ...
            <form action="register.php" method="post">
                <div class="row jumbotron box8">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="address" class="form-control" name="province" id="province" placeholder="Enter your province name." required>
                    </div>
                    <div class="col-sm-4 form-group">
                        <label for="city">City</label>
                        <input type="address" class="form-control" name="city" id="city" placeholder="Enter your city name." required>
                    </div>
                    <div class="col-sm-2 form-group">
                        <label for="zip">Postal-Code</label>
                        <input type="zip" class="form-control" name="zipcode" id="zip" placeholder="Postal-Code." required>
                    </div>
                    <div class="col-sm-6 form-group">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="Date" name="birth_date" class="form-control" id="Date" placeholder="" required>
                    </div>
                    <div class="col-sm-6 form-group">
                    ...
                    <div class="col-sm-2 form-group">
                        ...
                        <select class="form-control browser-default custom-select" name="country_code" id="cod">
                    ...
                    <div class="col-sm-12 form-group mb-3 mt-2">
    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                url: "master/mst_country.php",
                dataType: "json",
                success: function(replies) {
                    var select = $("select[name='country']")
                    select.empty()

                    select.append("<option disabled selected>Select Country</option>")
            ...
            $("select[name='country']").change(function() {
                ...
                $.ajax({
                    url: "master/mst_country_code.php",
